...
public class ModuleGuideLaTeXWriter extends ModuleGuideWriter {
    ...
    private static void writeDocumentStartStatic(
        ...
        Main.newLine(writer);
        writer.write("\\addbibresource{");
        if (innerDirectory) {
            writer.write("../");
        }
        writer.write("literature.bib}");
        Main.newLine(writer);
        Main.newLine(writer);
        writer.write(
        ...
        Main.newLine(writer);
        Main.newLine(writer);
        writer.write("\\DefineBibliographyStrings{ngerman}{%");
        Main.newLine(writer);
        writer.write("  page={S\\adddot},");
        Main.newLine(writer);
        writer.write("  pages={S\\adddot},");
        Main.newLine(writer);
        writer.write("  andothers={et al\\adddot},");
        Main.newLine(writer);
        writer.write("  urlalso={Online verfügbar unter},");
        Main.newLine(writer);
        writer.write("  urlfrom={Online verfügbar unter},");
        Main.newLine(writer);
        writer.write("}");
        Main.newLine(writer);
        Main.newLine(writer);
        writer.write("\\DeclareFieldFormat*{pages}{\\mkpageprefix[bookpagination]{#1}}");
        Main.newLine(writer);
        writer.write("\\DeclareFieldFormat*{url}{%");
        Main.newLine(writer);
        writer.write("  \\iffieldundef{urlyear}");
        Main.newLine(writer);
        writer.write("    {\\bibstring{urlalso}}");
        Main.newLine(writer);
        writer.write("    {\\bibstring{urlfrom}}%");
        Main.newLine(writer);
        writer.write("  \\addcolon\\space\\url{#1}%");
        Main.newLine(writer);
        writer.write("}");
        Main.newLine(writer);
        Main.newLine(writer);
    ...
    private static void writeExaminationTypes(
        ...
        writer.write("}}};");
        Main.newLine(writer);
        writer.write("\\node (ex0) [below=of ex] {\\phantom{g}\\textbf{A}\\phantom{g}};");
        Main.newLine(writer);
        writer.write("\\node (per0) at (ex0 -| per.west) [anchor=west] ");
        writer.write("{\\begin{minipage}{14cm}\\raggedright\\strut{}");
        writer.write(internationalization.internationalize(InternationalizationKey.THESIS_FORM));
        writer.write("\\strut{}\\end{minipage}};");
        Main.newLine(writer);
        writer.write("\\node (ex1) [below=of ex0] {\\phantom{g}\\textbf{K}\\phantom{g}};");
        Main.newLine(writer);
        ...
        writer.write("\\strut{}\\end{minipage}};");
        Main.newLine(writer);
        writer.write("\\node (exm) [below=of ex1] {\\phantom{g}\\textbf{M}\\phantom{g}};");
        Main.newLine(writer);
        writer.write("\\node (perm) at (exm -| per.west) [anchor=west] ");
        writer.write("{\\begin{minipage}{14cm}\\raggedright\\strut{}");
        writer.write(internationalization.internationalize(InternationalizationKey.ORAL_FORM));
        writer.write("\\strut{}\\end{minipage}};");
        Main.newLine(writer);
        writer.write("\\node (ex2) [below=of exm] {\\phantom{g}\\textbf{R}\\phantom{g}};");
        Main.newLine(writer);
        ...
        writer.write("\\strut{}\\end{minipage}};");
        Main.newLine(writer);
        writer.write("\\node (exp) [below=of ex4] {\\phantom{gXg}};");
        Main.newLine(writer);
        writer.write("\\node (ex5) [below=1.5 of ex4] {\\phantom{g}\\textbf{X}\\phantom{g}};");
        Main.newLine(writer);
        ...
        Main.newLine(writer);
        writer.write("\\coordinate (m1) at ($(ex0.south)!0.5!(ex1.north)$);");
        Main.newLine(writer);
        writer.write("\\coordinate (m0) at ($(ex.south)!0.5!(ex0.north)$);");
        Main.newLine(writer);
        writer.write("\\coordinate (m2) at ($(exm.south)!0.5!(ex2.north)$);");
        Main.newLine(writer);
        writer.write("\\coordinate (mm) at ($(ex1.south)!0.5!(exm.north)$);");
        Main.newLine(writer);
        writer.write("\\coordinate (m3) at ($(ex2.south)!0.5!(ex3.north)$);");
        Main.newLine(writer);
        writer.write("\\coordinate (m4) at ($(ex3.south)!0.5!(ex4.north)$);");
        Main.newLine(writer);
        writer.write("\\coordinate (m5) at ($(ex4.south)!0.5!(exp.north)$);");
        Main.newLine(writer);
        ...
        Main.newLine(writer);
        writer.write("\\draw[fhdwblue,thick] (m0 -| bottomleft) -- (m0 -| topright);");
        Main.newLine(writer);
        writer.write("\\draw[fhdwblue,thick] (m2 -| bottomleft) -- (m2 -| topright);");
        Main.newLine(writer);
        writer.write("\\draw[fhdwblue,thick] (mm -| bottomleft) -- (mm -| topright);");
        Main.newLine(writer);
    ...
    private static void writeItemizeSection(
        ...
        if (items != null && !items.isEmpty()) {
            ...
            Main.newLine(writer);
            Main.newLine(writer);
            final boolean doTwoColumns = twoColumns && items.size() > 4;
            if (doTwoColumns) {
    ...
    private static void writeLiteratureSection(
        ...
        if (literature != null && !literature.isEmpty()) {
            ...
            Main.newLine(writer);
            boolean first = true;
            for (final String source : literature) {
                if (first) {
                    first = false;
                } else {
                    writer.write("\\\\[1.5ex]");
